...
class TestJiraEndpoints:
    ...
    @patch("app.endpoints.jira_endpoints._make_jira_request")
    async def test_get_projects_success_mock(
        self,
        mock_request,
        auth_client,
        test_token
        ...
        assert data["projects"][0]["key"] == "TEST"
    
    @patch("app.endpoints.jira_endpoints._make_jira_request")
    async def test_search_issues_success_mock(
        self,
        mock_request,
        auth_client,
        test_token
