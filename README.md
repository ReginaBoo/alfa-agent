...
| :--- | :--- | :--- | :--- | :--- |
| `period` | `string` | Да | Фильтрация данных по временному отрезку. | `"Весь период"`, `"Последняя неделя"` |
...
| :--- | :--- | :--- | :--- |
| **`period`** | `string` | Да | Временной фильтр. Допустимые значения: `"Весь период"`, `"Последняя неделя"`. |
